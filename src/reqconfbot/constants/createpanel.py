class CreatePanel:
    ...
    MODAL_THUMBNAIL_URL_LABEL = "Ссылка на эскиз"
    MODAL_THUMBNAIL_URL_PLACEHOLDER = "Изображение вставленное в правом верхнем углу"
    MODAL_THEME_LABEL = "Тема заявок"
    MODAL_THEME_PLACEHOLDER = "Заявки на ..."
